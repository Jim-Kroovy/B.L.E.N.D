...
class JK_PG_ARL_TailFollow_Constraint(bpy.types.PropertyGroup):
    
    def update_constraint(self, context):
        armature = self.id_data
        rigging = armature.jk_arl.rigging[armature.jk_arl.active].tailfollow
...
class JK_PG_ARL_TailFollow_Bone(bpy.types.PropertyGroup):
...
class JK_PG_ARL_TailFollow_Twist(bpy.types.PropertyGroup):
    ...
    constraints: CollectionProperty(type=JK_PG_ARL_TailFollow_Constraint)
