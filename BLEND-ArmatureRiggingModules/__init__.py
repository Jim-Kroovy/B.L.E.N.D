...
def jk_arm_on_load_post(dummy):
    ...
    for armature in [o for o in bpy.data.objects if o.type == 'ARMATURE' and len(o.jk_arm.rigging) > 0]: 
...
jk_arm_classes = (
    ...
    # general properties...
    _properties_.JK_PG_ARM_Rigging, _properties_.JK_PG_ARM_Affixes, _properties_.JK_PG_ARM_Object,
    # operators...
