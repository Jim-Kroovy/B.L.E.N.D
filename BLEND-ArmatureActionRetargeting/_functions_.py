...
def Unbind_Pose_Bone(source, sb_name):
    rb_name = "RB_" + sb_name
    # go into edit mode and...
    bpy.ops.object.mode_set(mode='EDIT')
    ...
    # then into pose mode...
    bpy.ops.object.mode_set(mode='POSE')
    # to remove the binding contsraints...
    ...
    # set the bone property group Is Bound bool...
...
def Add_Offset_Action(source):
    ...
    new_offset = bpy.data.actions.new(source.name + "_OFFSET" + str(len(offsets)))
