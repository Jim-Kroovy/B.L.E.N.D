...
1. **Support Development** - Promotion for financial support because i put many long hours into development every week.
2. **Installation** - A little explanation of downloading and installing because i don't want to have to use Large File Storage.
3. **Contributing** - Some rules for contributions if by some miracle anybody wants to help out.
4. **License Overview** - The licensing overview section that you should probably read if you plan on downloading anything.
5. **Stable Add-ons** - A list of currently stable add-ons and any of their tasks that are being worked on.
6. **Unstable Add-ons** - A list of planned and work in progress add-ons that are not yet ready for release and any of their tasks that are being worked on.

- **Want to get to know me a little?** I have been working in Blender for 5 years and with Python for a little over 2 years and i have learned many little tricks and become very familiar with almost every aspect of the Blender API so i figured it was high time i started making some improvements both for the Blender community and myself by turning all my scripts and ideas into add-ons. I thoroughly enjoy writing Python and i can easily spend 12-16 hours a day working in Blender on these add-ons if i get the chance. I'm strongest with Armatures and Rigging and weakest with Materials and Lighting. 
...
- I will continue to update and improve the code and content of all these add-ons as i myself learn and advance my programming abilities.
